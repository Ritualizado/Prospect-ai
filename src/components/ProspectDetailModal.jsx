/**
 * components/ProspectDetailModal.jsx
 * -----------------------------------------------------------------------
        ...
        <div style={{ padding: 28 }}>
          ...
          <div style={{ background: "#0d1117", borderRadius: 8, padding: "12px 14px", marginBottom: 10 }}>
            ...
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
              <span style={{ fontSize: 13, color: "#94a3b8" }}>✉ {prospect.email}</span>
            ...
            <div style={{ background: "#0d1117", borderRadius: 8, padding: 14, marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                <input
                  ...
                  style={{ flex: 1 }}
                  onKeyDown={(e) => {
                    if (e.key === "Enter") onAddNote(prospect.id);
                  }}
                />
                <button
                  className="btn btn-p"
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", marginBottom: 16 }}>
            {!isSaved ? (
              <button className="btn btn-p" onClick={() => onSave(prospect)}>
                + Save as Lead
              </button>
            ) : (
              <select
