...
export default function LeadsTab() {
  ...
  const filteredLeads = useAppStore((s) => s.getFilteredLeads());

  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        <div>
          <h2 style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, fontSize: 22 }}>Leads</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {filteredLeads.map((lead) => (
            <div
              ...
              onClick={() => openProspectDetail(lead, "general")}
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
                <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: "#64748b", fontSize: 12, marginTop: 2 }}>✉ {lead.email || "Not publicly listed"}</p>
                  </div>
                </div>
